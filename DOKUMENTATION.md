...
Dieses Projekt erlebte drei Iterationen, alle mit unterschiedlichen AI-Assistenten. Zuerst war es CoPilot (das aber dann gestrichen wurde) und die VSC integrierung fand ich nicht sonderlich gut. Zweite Iteration lief mit Gemini Pro + Antigravity. Diese wurde nach einer Zeit zu unpräzise und zu teuer zu fixen. Die aktuelle und letzte Iteration lief mit Claude Opus 4.6-5.
Daraus habe ich ehrlich gesagt gelernt, dass ich gerne für eine App erstmal einen groben Durchlauf habe. Damit bin ich in der Lage bei der nächsten Iteration viel präziser voranzugehen, weil ich genau weiß was ich will und brauche. Die Anzahl an Prompts und Bedarf an Prompt-Iterationen ist im letzten Durchlauf enorm gesunken.